  ...
  return (
    <RealtimePageFrame>
      <section className='mx-auto my-auto w-full max-w-3xl border p-6' style={{ borderColor: `${colors.secondaryColor.color}66`, backgroundColor: `${colors.secondaryColor.color}1A` }}>
        ...
        <p className='mt-3 text-sm opacity-90'>Submit removal requests through support@scholarflow.ai and include your organization ID, email, and requested scope.</p>
