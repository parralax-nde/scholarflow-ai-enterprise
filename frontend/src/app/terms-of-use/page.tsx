  ...
  return (
    <RealtimePageFrame>
      <section className='mx-auto my-auto w-full max-w-3xl border p-6' style={{ borderColor: `${colors.secondaryColor.color}66`, backgroundColor: `${colors.secondaryColor.color}1A` }}>
        ...
        <p className='mt-4 text-sm opacity-90'>Use SimpleScholar responsibly and in compliance with applicable law, academic integrity guidelines, and your organization policy.</p>
